...
stationarity.test <- function(time.series, max.lag = NULL, advanced = FALSE) {
  ...
  if (advanced) {
    ...
    attr(stationarity.result, "series.name") <- time_series_name
  }
 
  structure(list(series.name = time_series_name,
