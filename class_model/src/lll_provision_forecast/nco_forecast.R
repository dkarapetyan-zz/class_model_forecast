...
NCOForecast <- function(position_data, model_coefficients, macro_forecasts) {
  ...
  .nco_forecast_df <- data.frame(ts(matrix(
              NA,
              ncol = length(cols)),
  ...
  for (i in 1:.nrows) {
    if (i == 1) {
      ...
      .nco_forecast_df$Other[i] <- (
            (position_data$CO..All.Other.Loans...000.
      ...
      .nco_forecast_df[i, .subset1] <- (model_coefficients["Intercept", .subset1] + 
            model_coefficients["Lagged.dependent.variable", .subset1] * .nco_forecast_df[(i - 
      ...
      .nco_forecast_df[i, .subset2] <- (model_coefficients["Intercept", .subset2]
      ...
      .nco_forecast_df[i, .subset3] <- (model_coefficients["Intercept", .subset3]
      ...
      .nco_forecast_df[i, .subset4] <- (model_coefficients["Intercept", .subset4]
      ...
      .nco_forecast_df[i, .subset5] <- (model_coefficients["Intercept", .subset5]
