...
data_200 <- read.csv("data_200.csv")
data_201 <- read.csv("data_201.csv")
...
# dim(data3)==dim(data2) TODO test if this is true or false--raise error
names(data3)
...
write.csv(data_200,file='data_200.csv')
write.csv(data_201,file='data_201.csv')
...
{ 
	...
	balance.ratio.mat.201[tt,8] <- PPNR.aggregate.t(x1="Total.Trading.Assets...000.", 
	y="Avg.Earning.Assets...000.", data.t=data_201,t=tt, f=400)

	balance.ratio.mat.201[tt,9] <- PPNR.aggregate.t(x1="Total.Securities...000.", 
	y="Avg.Earning.Assets...000.", data.t=data_201,t=tt, f=400)

}


f.zero<-function(x){return(ifelse(!is.na(x),x, 0))}
##########################code run skips from here  ##########################
#NonRisky portfolio >=2Q09-  numerator
AFS(F):US Treasury Secs ($000)
AFS(F):Govt Ag Secs ($000)
...
AFS(C):US Treasury Secs ($000)
AFS(C):Govt Ag Secs ($000)
...
AFS(F):CMOs (FNMA) (historical) ($000)
AFS(C):US Treasury Secs ($000)
AFS(C):Govt Ag Secs ($000)
AFS(C):Govt-Spons Ag ($000)
AFS(C):MBS GNMA (historical) ($000)
AFS(C):MBS Sp Ag (historical) ($000)
AFS(C):CMOs (FNMA) (historical) ($000)



NonRisky.AFS.post <- data_200$AFS.F..US.Treasury.Secs...000.+
data_200$AFS.F..Govt.Ag.Secs...000.+
data_200$AFS.F..Govt.Spons.Ag...000.+
...
data_200$AFS.C..US.Treasury.Secs...000.+
data_200$AFS.C..Govt.Ag.Secs...000.+
...
NonRisky.AFS.prior <- data_200$AFS.F..US.Treasury.Secs...000.+
data_200$AFS.F..Govt.Ag.Secs...000.+
data_200$AFS.F..Govt.Spons.Ag...000.+
data_200$AFS.F..MBS.GNMA..historical....000.+
data_200$AFS.F..MBS.Sp.Ag..historical....000.+
data_200$AFS.F..CMOs..FNMA...historical....000.+
data_200$AFS.C..US.Treasury.Secs...000.+
data_200$AFS.C..Govt.Ag.Secs...000.+
data_200$AFS.C..Govt.Spons.Ag...000.+
data_200$AFS.C..MBS.GNMA..historical....000.+
data_200$AFS.C..MBS.Sp.Ag..historical....000.+
data_200$AFS.C..CMOs..FNMA...historical....000.


######## Denominator	
#Total AFS Securities FV ($000)
#Total Securities AFS BV ($000)

##########################skipped code ends here  ##########################


NonRisky.AFS.post <- f.zero(data_200$AFS.F..US.Treasury.Secs...000.)+
f.zero(data_200$AFS.F..Govt.Ag.Secs...000.)+
f.zero(data_200$AFS.F..Govt.Spons.Ag...000.)+
f.zero(data_200$AFS.F...Pass.Through.RMBS..Guar.by.GNMA...000.)+
f.zero(data_200$AFS.F...Pass.Through.RMBS..Issd.by.FNMA.and.FHLMC...000.)+
f.zero(data_200$AFS.F...Other.RMBS..Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.F..Other.RMBS.Coll.by.MBS.Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.F...Pass.Through.CMBS.Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.F...Other.CMBS.Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.C..US.Treasury.Secs...000.)+
f.zero(data_200$AFS.C..Govt.Ag.Secs...000.)+
f.zero(data_200$AFS.C..Govt.Spons.Ag...000.)+
f.zero(data_200$AFS.C...Pass.Through.RMBS..Guar.by.GNMA...000.)+
f.zero(data_200$AFS.C...Pass.Through.RMBS..Issd.by.FNMA.and.FHLMC...000.)+
f.zero(data_200$AFS.C...Other.RMBS..Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.C..Other.RMBS.Coll.by.MBS.Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.C...Pass.Through.CMBS.Issd.or.Guar.by.GSEs...000.)+
f.zero(data_200$AFS.C...Other.CMBS.Issd.or.Guar.by.GSEs...000.) 

NonRisky.AFS.prior <- f.zero(data_200$AFS.F..US.Treasury.Secs...000.)+
f.zero(data_200$AFS.F..Govt.Ag.Secs...000.)+
f.zero(data_200$AFS.F..Govt.Spons.Ag...000.)+
f.zero(data_200$AFS.F..MBS.GNMA..historical....000.)+
f.zero(data_200$AFS.F..MBS.Sp.Ag..historical....000.)+
f.zero(data_200$AFS.F..CMOs..FNMA...historical....000.)+
f.zero(data_200$AFS.C..US.Treasury.Secs...000.)+
f.zero(data_200$AFS.C..Govt.Ag.Secs...000.)+
f.zero(data_200$AFS.C..Govt.Spons.Ag...000.)+
f.zero(data_200$AFS.C..MBS.GNMA..historical....000.)+
f.zero(data_200$AFS.C..MBS.Sp.Ag..historical....000.)+
f.zero(data_200$AFS.C..CMOs..FNMA...historical....000.)

AFS.Total <- f.zero(data_200$Total.Securities.AFS.BV...000.)+f.zero(data_200$Total.AFS.Securities.FV...000.)
balance.ratio.mat.200[,11]<-ifelse(data_200$Time.trend>=(2009-1991+0.5), 
100-100*NonRisky.AFS.post/AFS.Total, 100-100*NonRisky.AFS.prior/AFS.Total)
...

{
	...
	NonRisky.AFS.post.tt <- sum(f.zero(data$AFS.F..US.Treasury.Secs...000.)+
	f.zero(data$AFS.F..Govt.Ag.Secs...000.)+
	f.zero(data$AFS.F..Govt.Spons.Ag...000.)+
	f.zero(data$AFS.F...Pass.Through.RMBS..Guar.by.GNMA...000.)+
	f.zero(data$AFS.F...Pass.Through.RMBS..Issd.by.FNMA.and.FHLMC...000.)+
	f.zero(data$AFS.F...Other.RMBS..Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.F..Other.RMBS.Coll.by.MBS.Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.F...Pass.Through.CMBS.Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.F...Other.CMBS.Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.C..US.Treasury.Secs...000.)+
	f.zero(data$AFS.C..Govt.Ag.Secs...000.)+
	f.zero(data$AFS.C..Govt.Spons.Ag...000.)+
	f.zero(data$AFS.C...Pass.Through.RMBS..Guar.by.GNMA...000.)+
	f.zero(data$AFS.C...Pass.Through.RMBS..Issd.by.FNMA.and.FHLMC...000.)+
	f.zero(data$AFS.C...Other.RMBS..Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.C..Other.RMBS.Coll.by.MBS.Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.C...Pass.Through.CMBS.Issd.or.Guar.by.GSEs...000.)+
	f.zero(data$AFS.C...Other.CMBS.Issd.or.Guar.by.GSEs...000.))

	NonRisky.AFS.prior.tt <- sum(f.zero(data$AFS.F..US.Treasury.Secs...000.)+
	f.zero(data$AFS.F..Govt.Ag.Secs...000.)+
	f.zero(data$AFS.F..Govt.Spons.Ag...000.)+
	f.zero(data$AFS.F..MBS.GNMA..historical....000.)+
	f.zero(data$AFS.F..MBS.Sp.Ag..historical....000.)+
	f.zero(data$AFS.F..CMOs..FNMA...historical....000.)+
	f.zero(data$AFS.C..US.Treasury.Secs...000.)+
	f.zero(data$AFS.C..Govt.Ag.Secs...000.)+
	f.zero(data$AFS.C..Govt.Spons.Ag...000.)+
	f.zero(data$AFS.C..MBS.GNMA..historical....000.)+
	f.zero(data$AFS.C..MBS.Sp.Ag..historical....000.)+
	f.zero(data$AFS.C..CMOs..FNMA...historical....000.))
...
for (tt in (1: T))
{
	...
	balance.ratio.mat.201[tt,10] <- 100*sum(na.rm=TRUE,data_201$Total.Assets...000.[data_201$Time.trend==tt/4])/Total.Assets
}
